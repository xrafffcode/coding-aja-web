    ...
    <div class="container-xxl mx-auto p-0  position-relative header-2-3" style="font-family: 'Poppins', sans-serif;">
      <nav class="navbar navbar-expand-lg navbar-dark">
              ...
              <div class="modal-body" style="padding:	2rem; padding-top: 0; padding-bottom: 0;">
                <ul class="navbar-nav responsive me-auto mt-2 mt-lg-0">
                  ...
                  <li class="nav-item  active">
                    <a class="nav-link" href="#" style="color: #E7E7E8;">Contact</a>
                  </li>
                </ul>
              </div>
        ...
        <div class="collapse navbar-collapse" id="navbarTogglerDemo">
          ...
          <div class="gap-3">
            <button class="btn btn-default btn-no-fill">Masuk</button>
            <button class="btn btn-fill text-white border-0">Daftar</button>
          </div>
        </div>
      </nav>
      <div>   
        <div class="mx-auto d-flex flex-lg-row flex-column hero">
          ...
          <div class="left-column d-flex flex-lg-grow-1 flex-column align-items-lg-start text-lg-start align-items-center text-center">
            <div data-aos="zoom-in">
                 <h1 class="title-text-big">We’re Happy to Help You Today!</h1>
            </div>           
            <div class="d-flex flex-sm-row flex-column align-items-center mx-lg-0 mx-auto justify-content-center gap-3">
              <div data-aos="zoom-in">
                  <p style="color: white;">
                   Hubungi kami melalui salah satu channel
yang telah kami sediakan di bawah
                  </p>
              </div>
            </div>
          </div>
          ...
          <div class="right-column text-center d-flex justify-content-center pe-0">
            <div data-aos="zoom-in">
                <img id="img-fluid" class="h-auto mw-100" src="/assets/img/contact-image.png" alt="hero-img" width="280" height="349">
            </div>
          </div>
        </div>
      </div>
     ...
     <div class="content-2-3 container-xxl mx-auto p-0  position-relative" style="font-family: 'Poppins', sans-serif">  
        ...
        <div class="row section scrolling-wrapper flex-row flex-nowrap mt-3 mx-2">
               <div class="row" id="load_data">                   
                    <div class="col-sm-6 mb-3">
                        <div data-aos="zoom-in">
                            <div class="card" style="color: white;">
                                <img src="/assets/img/ic_whatsapp.svg" class="mx-3" alt="gambar" width="90">
                                <div class="card-body text-decoration-none">
                                  ...
                                  <a href="https://api.whatsapp.com/send?phone=6285325483259&text=Hai%20Coding%20Aja!">                           
                                  <button type="button" class="btn-card text-white w-100">Chat Sekarang</button>
                                  </a> 
                                </div>                             
                            </div>
                        </div>
                    ...
                    <div class="col-sm-6 mb-3">
                        <div data-aos="zoom-in">
                            <div class="card" style="color: white;">
                                <img src="/assets/img/ic_email.svg  " class="mx-3" alt="gambar" width="90">
                                <div class="card-body text-decoration-none">
                                  <h5 class="card-title">
                                  ...
                                  <a href="mailto:zthteamdev@gmail.com">                           
                                  <button type="button" class="btn-card text-white w-100">Kirim Email</button>
                                  </a> 
                                </div>                             
                            </div>
                        </div>
    ...
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.0.0-beta2/dist/js/bootstrap.bundle.min.js" integrity="sha384-b5kHyXgcpbZJO/tY9Ul7kGkf1S0CWuKcCD38l8YkeH8z8QjE0GmW1gYU5S9FOnJ0" crossorigin="anonymous"></script>
     ...
     <section class="h-100 w-100 mt-5" style="box-sizing: border-box; background-color: #141432">
