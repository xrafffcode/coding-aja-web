...
<html lang="en">
    <head>
        ...
        <meta name="description" content="<?php echo $result['nama_kelas']?>" />
        <meta name="author" content="" />
        <title><?php echo $result['nama_kelas']?></title>
    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg navbar-light" id="mainNav">
            <div class="container px-4 px-lg-5">
                <a class="navbar-brand" href="/index.php">Coding Aja</a>
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ms-auto py-4 py-lg-0">
                        ...
                        <li class="nav-item"><a class="nav-link px-lg-3 py-3 py-lg-4" href="/pages/kelas.php">Kelas</a></li>
                        <li class="nav-item"><a class="nav-link px-lg-3 py-3 py-lg-4" href="/pages/about.php">About Us</a></li>
        ...
        <!-- Page Header-->
        <header class="masthead" style="background-image: url('../assets/img_kelas/<?php echo $result['gambar_kelas']?>')">
            <div class="container position-relative px-4 px-lg-5">
                <div class="row gx-4 gx-lg-5 justify-content-center">
                    <div class="col-md-10 col-lg-8 col-xl-7">
                        <div data-aos="zoom-in">
                            <div class="post-heading">
                                <h1><?php echo $result['nama_kelas']?></h1>
        ...
        <article class="mb-4">
            <div class="container px-4 px-lg-5">
                ...
                <div class="row gx-4 gx-lg-5 justify-content-center">
                    <div class="col-md-10 col-lg-8 col-xl-7">
                        <div data-aos="zoom-in">
                            <img class="img-fluid" src="../assets/img_kelas/<?php echo $result['gambar_kelas']?>" alt="..." />
                            
                        </div>
                        <div data-aos="fade-up" data-aos-anchor-placement="top-bottom">
                            <p>
                                <?php echo nl2br ($result['isi_kelas'])?>
                            </p>                          
                        </div>                                     
                    </div>
                </div>
